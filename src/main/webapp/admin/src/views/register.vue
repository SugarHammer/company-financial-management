  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">公司财务管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yuangongguanli'" class="input-group">
			   <div class="label">管理工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.guanligonghao" class="input" type="text" placeholder="管理工号">
			   </div>
			 </div> -->
			<el-form-item label="管理工号" class="input" v-if="tableName=='yuangongguanli'">
			  <el-input v-model="ruleForm.guanligonghao" autocomplete="off" placeholder="管理工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangongguanli'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yuangongguanli'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangongguanli'" class="input-group">
			   <div class="label">管理姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.guanlixingming" class="input" type="text" placeholder="管理姓名">
			   </div>
			 </div> -->
			<el-form-item label="管理姓名" class="input" v-if="tableName=='yuangongguanli'">
			  <el-input v-model="ruleForm.guanlixingming" autocomplete="off" placeholder="管理姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangongguanli'" class="input-group">
			...
			<el-form-item label="职位" class="input" v-if="tableName=='yuangongguanli'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yuangongguanli'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangongguanli'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yuangongguanli'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangongguanli'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yuangongguanli'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.guanligonghao) && `yuangongguanli` == this.tableName){
        this.$message.error(`管理工号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `yuangongguanli` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`yuangongguanli` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`yuangongguanli` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`yuangongguanli` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("https://www.landray.com.cn/api/upload-files/image/info/content/image/202103-ab0e4f27-7a1e-4eee-b41d-383055924dae.jpg");
		height: 100vh;
